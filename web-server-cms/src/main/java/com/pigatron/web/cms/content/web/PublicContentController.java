...
import com.pigatron.web.cms.content.repository.PostQuery;
...
public class PublicContentController  {
    ...
    public List<Content> getPosts(@RequestParam(value="page", required=false) Integer page,
        ...
        postQuery.setSortablePageable(page, length, direction, sortProperty);
        return contentService.getPosts(postQuery);
    }
